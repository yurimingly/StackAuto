...
slack = Slacker('xoxb-1600375133346-1593601096278-097gpIqbfk3o9rjHnuYEoC2I')
def dbgout(message):
...
def buy_etf(code):
    ...
    try:
        ...
        dbgout("`buy_etf 샀다 "+ str(code) + " -> exception! " + str(ex) + "`")
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A069500','A305720','A305540'] #,'A229200','A253250' #kodex코스닥150#kosef200선물레버리지
                      #kodex200#kodex2차전지산업#tiger2차전지테마
         #'A145670', 'A123310', 'A114800', 'Q500022'  #kindex 인버스, tiger 인버스, kodex 인버스, 신한 인버스 천연가스 선물
        ...
        while True:
            ...
            printlog("//today 지금: ",today ,"//t_now 지금: ",t_now)
            #,"//t_start 시작시간: ",t_start,'\n'
            #,"t_sell 팔시간: ",t_sell,"//t_exit 프로그램종료: ",t_exit)
            
           
            if today == 5 or today == 6:  # 토요일이나 일요일이면 자동 종료
                printlog('Today is', 'Saturday.' if today == 5 else 'Sunday.')
                dbgout('토요일이나 일요일은 장 휴식이므로 유유림의 봇 종료')
                sys.exit(0)
